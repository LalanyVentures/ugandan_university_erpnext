...
import { LecturerAttendanceModalPage } from './pages/attendance/LecturerAttendanceModalPage'
import { LecturerAssessmentPage } from './pages/results/LecturerAssessmentPage'
import { LecturerMarksWorkspace } from './pages/results/LecturerMarksWorkspace'
...
export function LecturerApp({session,onLogout}:{session:UniversitySession;onLogout:()=>void}){return <LecturerPortalProvider><LecturerShell session={session} onLogout={onLogout}><Routes>
  ...
  <Route path="/lecturer/attendance" element={<LecturerAttendanceModalPage/>}/><Route path="/lecturer/assessments" element={<LecturerAssessmentPage view="assessments"/>}/><Route path="/lecturer/marks" element={<LecturerMarksWorkspace/>}/><Route path="/lecturer/results" element={<LecturerAssessmentPage view="results"/>}/><Route path="/lecturer/reviews" element={<LecturerAssessmentPage view="reviews"/>}/><Route path="/lecturer/submissions" element={<LecturerAssessmentPage view="submissions"/>}/>
