...
import { FinanceAccountDrawer } from '../../components/FinanceAccountDrawer'

export function FinanceAccountsPage() {
  const navigate = useNavigate(), [params, setParams] = useSearchParams(), [query, setQuery] = useState(params.get('q') ?? ''), [selected,setSelected]=useState<Record<string,unknown>|null>(null)
